...
- 与 Godot 的状态同步契约:业务 store 的 selector 上挂 `subscribe`,变化时调用 `services/godot/godotApi.sendEntityState()` 推送 signal。详见 [pixel-foundation.md](../pixel-foundation.md) "RN ↔ Godot 通信契约"
